    ...
    <div>
        <transition appear appear-class="app-appear" appear-active-class="app-appear-active">
            <div class="container mt-4 mb5">
                <h3 class="lesson-subheading">Marching queens</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 app--lesson-left">
                        <div>
                            ...
                            <button @click="appendGrid" class="btn btn-outline-success btn-lg" v-if="button1">Play Demo</button>
                            </div>
                            <div>
                            <button @click="playAuto" class="btn btn-outline-success btn-lg" v-if="button2">{{PlayAuto}}</button>
                            </div>
                            </div>
                            <br>
                            <div class="row">
                    ...
                    <div class="col-12 col-md-6 app--lesson-right" style="overflow: visible;">
                        ...
                        <div class="tt-right-box">
                            ...
                            <p>
                                <span style="font-size: 115%;" class="badge badge-dark">{{ countMove }}</span> Moves
                            </p>
                            <p>
    ...
    export default {
        ...
        data: function () {
            return{
                ...
                instruction:"Click on row 1 to place the first queen",
        ...
        methods:{
            appendGrid:function(){
                ...
                var parent;
                 ...
                 if(this.countOfReached==1&&countOfCovered==8){
                     this.terminate = true
                     this.PlayAuto = "Reset"
                 }
            ...
            playAuto: async function(){
                if(this.PlayAuto=="Reset"){
                    this.reset()
                }
                else if(this.PlayAuto=="Play Auto") {
                    this.button1 = false
