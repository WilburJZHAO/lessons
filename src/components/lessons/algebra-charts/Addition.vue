  ...
  <div>
    ...
    >
      <div class="container mt-4 mb5">
        <h3 class="lesson-subheading">Addition</h3>
                ...
                <tr v-for="i in selected + 1">
                  ...
                  >
                    ...
                    <b
                      ...
                      "
                      >{{
                        arrSimpleThree[j - 2] === 0
                          ? arrSimpleOne[j - 2]
                          : arrSimpleThree[j - 2] === 1
                          ? "x+" + arrSimpleOne[j - 2]
                          : arrSimpleThree[j - 2] === -1
                          ? "-x+" + arrSimpleOne[j - 2]
                          : arrSimpleThree[j - 2] + "x+" + arrSimpleOne[j - 2]
                      }}</b
                    >
                    <b
                      v-else-if="
                    ...
                    <b
                      ...
                      >{{
                        arrSimpleFour[i - 2] === 0
                          ...
                          : arrSimpleFour[i - 2] === -1
                          ? "-x+" + arrSimpleTwo[i - 2]
                          : arrSimpleFour[i - 2] + "x+" + arrSimpleTwo[i - 2]
                      }}</b
                    >
                    <b
                      v-else-if="
                    ...
                    <b
                      v-else-if="
                        i === r[0] + 1 &&
                          j === c[0] + 1 &&
                          arrSimpleOne[j - 2] + arrSimpleTwo[i - 2] > 0
                      "
                      >{{
                        arrSimpleThree[j - 2] + arrSimpleFour[i - 2] === 0
                          ? arrSimpleTwo[i - 2] + arrSimpleOne[j - 2]
                          : arrSimpleThree[j - 2] + arrSimpleFour[i - 2] === 1
                          ? "x+" + (arrSimpleTwo[i - 2] + arrSimpleOne[j - 2])
                          : arrSimpleThree[j - 2] + arrSimpleFour[i - 2] === -1
                          ? "-x+" + (arrSimpleTwo[i - 2] + arrSimpleOne[j - 2])
                          : arrSimpleThree[j - 2] +
                            arrSimpleFour[i - 2] +
                    ...
                    <b
                      ...
                      >{{
                        arrSimpleThree[j - 2] + arrSimpleFour[i - 2] === 0
                          ...
                          : arrSimpleThree[j - 2] + arrSimpleFour[i - 2] === -1
                          ? "-x"
                          : arrSimpleThree[j - 2] + arrSimpleFour[i - 2] + "x"
                      }}</b
                    >
                    <b
                      v-else-if="
                      ...
                      >{{
                        arrSimpleThree[j - 2] + arrSimpleFour[i - 2] === 0
                          ? arrSimpleOne[j - 2] + arrSimpleTwo[i - 2]
                          : arrSimpleThree[j - 2] + arrSimpleFour[i - 2] === 1
                          ? "x" + (arrSimpleOne[j - 2] + arrSimpleTwo[i - 2])
                          : arrSimpleThree[j - 2] + arrSimpleFour[i - 2] === -1
                          ? "-x" + (arrSimpleOne[j - 2] + arrSimpleTwo[i - 2])
                          : arrSimpleThree[j - 2] +
                            arrSimpleFour[i - 2] +
                    ...
                    <b v-else-if="i === 1 && j !== 1"
                      ><input
                        ...
                        v-on:keyup="checkNum(i, j, inputNum[i * 10 + j])"
                        type="text"
                        style="width: 5vw; height: 5vw; background: rgba(165, 220, 255, 1); border: 0px"
                    /></b>
                    <b v-else-if="j === 1 && i !== 1"
                      ><input
                        :ref="i * 10 + j"
                    ...
                    <b v-else
                      ><input
                        ...
                        type="text"
                        style="width: 5vw; height: 5vw; border: 0px"
                    /></b>
                  </td>
                </tr>
              </table>
            ...
            <div>
              ...
              >
                ...
                <div
                  ...
                  style="min-width: 500px; height: 400px; margin: 0 auto;"
                >
                  <div>
                    <h5>Graph</h5>
    ...
    start() {
      document
        ...
        .rows[0].cells[0].setAttribute(
          "style",
          "width: 6vw; height: 5vw; background: #ffeaa5"
        );
      this.generateTable();
    },
    randomsort() {
    ...
    generateTable: function() {
      ...
      if (this.selected1 === "l1") {
        ...
        for (m = 0; m < i; m++) {
          ...
          random3 = Math.floor(Math.random() * 10) - 5;
          if (random3 === 0) {
            random3 = Math.floor(Math.random() * 5) + 1;
          }
          random4 = Math.floor(Math.random() * 10) - 5;
          if (random4 === 0) {
        ...
        if (this.checkRow[i] === 1) {
          if (
            this.isEqual(
              ...
              this.arrSimpleThree[this.checkCol[i] - 2]
            )
          ) {
          ...
          if (
            this.isEqual(
              ...
              this.arrSimpleFour[this.checkRow[i] - 2]
            )
          ) {
            if (this.$refs[index][0].classList.value === "red") {
              this.$refs[index][0].classList.replace("red", "g");
