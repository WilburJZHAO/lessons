                                ...
                                <tr v-for="i in selected + 1">
                                    <td v-for="j in selected + 1" :style="
                                      (j === 1 && i !== 1)||(i===1&&j!==1)
                                        ...
                                        <b v-else-if="i===r[2]+1&&j===c[2]+1&& h">
                                            {{arrSimpleThree[j-2]/root[i-2]*arrSimpleTwo[i-2]}}
                                        </b>
                                        <b v-else-if="i===r[2]+1&&j===c[3]+1&& h">
                                            {{arrSimpleThree[j-2]/root[i-2]*arrSimpleTwo[i-2]}}
                                        </b>
                                        <b v-else-if="i===r[3]+1&&j===c[3]+1&& h">
                                            {{arrSimpleThree[j-2]/root[i-2]*arrSimpleTwo[i-2]}}
                                        </b>
                                        <b v-else-if="i===1&&j!==1">
    ...
    export default {
        ...
        methods: {
            ...
            generateTable: function() {
                ...
                if (switcher < 3) {
                    this.alertMessage = "Please select more than three options";
                    this.h = false;
                }
                else {
                    this.h = true;
                    ...
                    this.root.push(this.arrSimpleOne.pop());
                    this.root.push(this.arrSimpleOne.pop());
                    let temp = this.lcm(this.lcm(this.root[0],this.root[1]),this.root[2]);
                    for (let i = 0; i < 3; i++) {
                    ...
                    if(this.arrSimpleThree[0] === this.arrSimpleThree[1] || this.purify(this.root[0],this.arrSimpleTwo[0]) === this.purify(this.root[1],this.arrSimpleTwo[1])||this.arrSimpleThree[1]===this.arrSimpleThree[2]||this.arrSimpleThree[0]===this.arrSimpleThree[2]){
                        this.generateTable();
                    }
                }
