    ...
    <div>
        ...
        <div class="container-fluid" v-else>
            <transition appear appear-class="lesson-appear" appear-active-class="lesson-appear-active">
                <app-top-nav @backToMenu="selectedOption = $event">Steps</app-top-nav>
            </transition>

            <transition appear appear-class="lesson-appear" appear-active-class="lesson-appear-active">
                <app-step-puzzle v-if="selectedOption === 1"></app-step-puzzle>
...
<script>
    ...
    import StepPuzzle from './StepsPuzzle.vue'
