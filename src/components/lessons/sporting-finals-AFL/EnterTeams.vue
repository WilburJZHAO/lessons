    ...
    export default {
        ...
        data: function(){
            return{
                ...
                plus12: false,
                randomPick : false,
                AFL : ["Adelaide Crows","Brisbane Lions","GWS Giants","Carlton","Gold Coast Suns","Collingwood","Essendon","Fremantle","Geelong Cats","Hawthorn","Kangaroos","Melbourne",
                    "Port Adelaide","Richmond","St Kilda","Sydney Swans","West Coast Eagles","Western Bulldogs"],
                picked:"One",
        ...
        methods:{
            ...
            choose: function(event){
                ...
                var count = 0
                if(cur.classList == "badge badge-success"||cur.classList=="badge badge-secondary"){
...
<style scoped>
    ...
    .app--lesson-action .plusAName:hover,.app--lesson-action .plusAName:hover span{
        background: #7f8c8d;
    }
